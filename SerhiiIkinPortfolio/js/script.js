    ...
    sendBtn.addEventListener("click", function () {
        ...
        function formValidate(form) {
            ...
            if (!formReq[0].value) {
                ...
                newDiv.style =
                    "position: absolute; color:red; font-size:12px; padding: 3px 0 0 5px;";
            ...
            if (!formReq[2].value && !formReq[3].value) {
                ...
                var newContent2 = document.createTextNode(
                    "Write your mobil phone or email!"
                );
                newDiv2.style =
                    "position: absolute; color:red; font-size:12px; padding: 3px 0 0 5px;";
            ...
            if (formReq[2].value || formReq[3].value) {
                if (formReq[3].value) {
                    if (emailTest(formReq[3])) {
                        formAddError(formReq[3]);
                        error++;
                    }
                }
                if (mobTel.value) {
                    if (mobTel.value.length < 8) {
                        formAddError(mobTel);
                        error++;
                    }
                }
...
var openMod = document.querySelector(".top__content__btn");
